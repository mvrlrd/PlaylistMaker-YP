...
sealed class AddPlaylistScreenState  {
    ...
    object InitEditTextFields: AddPlaylistScreenState(){
        override fun render(binding: FragmentAddPlaylistBinding) {
                initDescriptionEditText(binding.descriptionEtContainer.nameEt, binding.descriptionEtContainer.clearTextButton)
            initNameEditText(binding.nameEtContainer.nameEt, binding.nameEtContainer.clearTextButton, binding.createPlaylistButton)
        }
...
//                    viewModel.searchDebounce(binding.searchEditText.text.toString())
        ...
        private fun initNameEditText(editText:EditText, clearTextButton: ImageButton, createButton: Button) {
            editText
                .apply {
//                setOnEditorActionListener { _, actionId, _ ->
//                    onClickOnEnterOnVirtualKeyboard(actionId)
