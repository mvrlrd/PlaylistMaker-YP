...
class PlaylistItemDiffCallback: DiffUtil.ItemCallback<PlaylistForAdapter>() {
    override fun areItemsTheSame(oldItem: PlaylistForAdapter, newItem: PlaylistForAdapter): Boolean {
        return oldItem.playlistId == newItem.playlistId
    }

    override fun areContentsTheSame(oldItem: PlaylistForAdapter, newItem: PlaylistForAdapter): Boolean {
